...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header">
            <h5>Templates</h5>
            <a href="{{ route('CreateTemplate') }}" class="btn rounded-pill btn-primary">Create</a>
        </div>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                                    ...
                                    <a  href="{{ route('ShowTemplate', [ 'id' => $item->id ]) }}"><i class="bx bx-show-alt me-1"></i> </a>
                                    <a  href="{{ route('EditTemplate', [ 'id' => $item->id ]) }}"><i class="bx bx-edit-alt me-1"></i> </a>
                                    <a  href="{{ route('DeleteTemplate', [ 'id' => $item->id ]) }}" onclick="return confirm('Are you sure you want to delete this item?')"><i class="bx bx-trash me-1"></i> </a>
