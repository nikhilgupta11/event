        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Event Organizer Create</h5>
                    ...
                    <form action="{{ route('StoreEventOrganizer') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-sm-6">
                                <label class="form-label" for="basic-default-categoryname">Name <span class="required">*</span></label>
                                <input type="text" class="form-control" id="basic-default-categoryname" name="name" placeholder="Name" />
                            </div>
                            <div class="mb-3 col-sm-6">
                                <label for="exampleFormControlSelect1" class="form-label">Language <span class="required">*</span></label>
                            ...
                            <div class="mb-3 col-sm-6">
                                <label for="html5-date-input" class="col col-form-label">Time Duration<span class="required">*</span></label>
                                <input class="form-control" type="text" name="time_duration" id="html5-date-input" placeholder="Enter Time Duration" />
                            </div>
                            <div class="mb-3 col-sm-6">
                                <label class="form-label" for="basic-default-categoryname">Age <span class="required">*</span></label>
