...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-header">
            <h5>Food Stores</h5>
            <a href="{{ route('CreateFoodStores') }}" class="btn rounded-pill btn-primary">Create</a>
        </div>
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('ShowFoodStore', [ 'id' => $item->id ]) }}"><i class="bx bx-show-alt me-1"></i> </a>
                            <a href="{{ route('EditFoodStore', [ 'id' => $item->id ]) }}" ><i class="bx bx-edit-alt me-1"></i> </a>
                            <a href="{{ route('DeleteFoodStore', ['id' => $item->id]) }}" onclick="return confirm('Are you sure you want to delete this item?')"><i class="bx bx-trash me-1"></i> </a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
