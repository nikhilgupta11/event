		...
		<div class="col-xl">
			<div class="card mb-4">
				<div class="card-header d-flex justify-content-between align-datas-center">
					<div class="col col-md-6"><b>Food Store Details</b></div>
					<div class="col col-md-6">
						<a href="{{ route('FoodStores') }}" class="btn btn-primary btn-sm float-end">Back</a>
					</div>
				</div>
				<div class="card-body">
					<div class="row">
						...
						<label for="" class="col-label-form"><b>Gallary</b></label><br>
