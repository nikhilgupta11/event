...
<section class="section dashboard">
    <form action="{{ route('updateevent', $event->id) }}" id="regForm" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row">
            ...
            <div class="mb-3 col-sm-4">
                ...
                <input class="form-control" value="{{ $event->start_date }}" type="date" name="start_date" id="html5-date-input" />
            </div>
            <div class="col-sm-4">
                <label for="html5-date-input" class="col-md-3 col-form-label">End Date <span class="required">*</span></label>
                <input class="form-control" value="{{ $event->end_date }}" type="date" id="html5-date-input" name="end_date" />
            </div>
            ...
            <div class="mb-3 col-sm-1">
                ...
                <a href="{{ route('food_store_delete1', $food->id) }}"><i class="bx bxs-trash"></i></a>
            </div>
            @endforeach
            @endif
            ...
            <div class="mb-3 col-sm-1">
                <label for="exampleFormControlSelect1" class="form-label">Delete</label> <br>
                <a href="{{ route('artist_delete1',$art->id ) }}"><i class="bx bxs-trash"></i></a>
            </div>
            @endforeach
            @endif
            ...
            <div class="mb-3 col-sm-3">
                <label for="exampleFormControlSelect1" class="form-label">Delete</label><br>
                <a href="{{ route('ticket_delete1', $ticket->id) }}"><i class="bx bxs-trash"></i></a>
            </div>
            @endforeach
            @endif
