        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Create Food Store</h4>
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('StoreFoodStoreOrganizer') }}" id="regForm" method="POST" name="formPrevent" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="mb-3 col-sm-14">
                            ...
                            <textarea type="text" class="form-control content" name="description" id="description" placeholder="Description"></textarea>
                        </div>
