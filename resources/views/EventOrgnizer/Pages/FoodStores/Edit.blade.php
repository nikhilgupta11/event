        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Food Store</h4>
                    <a href="{{ route('FoodStoresOrganizer') }}" class="btn rounded-pill btn-primary">Back</a>
                </div>
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('UpdateFoodStoreOrganizer', $data->id) }}" method="POST" name="formPrevent" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-sm-12">
                                ...
                                <textarea class="form-control content" name="food_description[]" id="food_description" placeholder="Description"> {{$menu->description}}</textarea>
                            </div>
                            ...
                            <div class="mb-3 col-sm-2">
                                <a href="{{  route('DeleteFoodMenu' ,$menu->id) }}" class="btn btn-danger"><i class="bx bx-trash"></i></a>
                            </div>
                        </div>
                        <br><br>
                        @endforeach
                        ...
                        <div id="tableRow" class="Food_menu">
                            <div class="row food_content">
                                ...
                                <div class="mb-3 col-sm-12">
                                    ...
                                    <textarea type="text" class="form-control content" name="food_description[]" id="food_description" placeholder="Description"></textarea>
                                </div>
