                            ...
                            <div class="card mb-3">
                                ...
                                <h5 class="card-title text-center pb-0 fs-4">
                                    ...
                                    <div class="pb-2">
                                        ...
                                        <p class="text-center small">Enter Email & Password to Register</p>
                                    </div>

                                    <form class="row g-3 needs-validation" novalidate action="{{ route('orgregister') }}" method="POST">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <div class="col-12 mt-4">
                                        <p class="small mb-0">Already have an account? <a href="{{ route('EventOrg') }}">Log in</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
