                            ...
                            <div class="card mb-3">
                                ...
                                <h5 class="card-title text-center pb-0 fs-4">
                                    ...
                                    <div class="pb-2">
                                        ...
                                        <p class="text-center small">Enter your email here</p>
                                    </div>

                                    <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('forgotpass') }}">
                                        @csrf
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Email</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="email" name="email" placeholder="Enter Your Email" class="form-control" id="Your Email" required>
                                    ...
                                    <div class="col-12 mt-4">
                                        <p class="small mb-0">Login to Account? <a href="{{ route('EventOrg') }}">Log in</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
