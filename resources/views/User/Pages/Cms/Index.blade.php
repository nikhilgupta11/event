            ...
            <div class="container">
                <div class="category-browse--header-text">
                    <div class="category-browse--header-text__wrapper">
                        <h1 class="category-browse__header--content">
...
<style>
    ...
    .main-container .container span, .main-container .container p, .main-container .container h6 {
    ...
    .main-container{
        background-image: url(https://media.istockphoto.com/id/1146367620/vector/abstract-white-background.jpg?s=612x612&w=0&k=20&c=v6spf6OW1BS6KaM4Lz3BEfYK8_o5hUHF_4NvcpBpn6w=);
