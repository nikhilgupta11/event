...
class ArtistsController extends Controller
{
    ...
    {
        $data = Artist::all();
        return view('SuperAdmin/Pages/Artists/Index', compact('data'));
    }

    public function create()
    {
        $data = Expertize::where('status', 1)->get();
        return view('SuperAdmin/Pages/Artists/Create', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('SuperAdmin/Pages/Artists/Edit', compact('data', 'art_expertize', 'exp'));
    }
    ...
    public function show($id)
    {
        ...
        return view('SuperAdmin/Pages/Artists/Show', compact('item', 'exp1'));
    }
    ...
    public function delete($id)
    {
        ...
        DB::table('artist_expertize')->where('artist_id', $id)->delete();
        return redirect()->route('Artists')->with('error', 'Artist Has Been Deleted successfully');
    }
}
