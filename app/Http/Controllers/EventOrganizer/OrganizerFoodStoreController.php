...
class OrganizerFoodStoreController extends Controller
{
    public function index()
    {
        $data = FoodStore::where('type', '2')->get();
        return view('EventOrgnizer/Pages/FoodStores/Index', compact('data'));
    }

    public function create()
    {
        return view('EventOrgnizer/Pages/FoodStores/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('FoodStoresOrganizer')->with('success', 'Food Store has been created successfully.');
        }
    }
    ...
    public function edit($id)
    {
        ...
        // dd($food_menu);
        return view('EventOrgnizer/Pages/FoodStores/Edit', compact('data', 'food_menu'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('FoodStoresOrganizer')
    ...
    public function show($id)
    {
        ...
        $food_menu = DB::table('food_store_menu')->where('food_store_id', $id)->get();
        return view('EventOrgnizer/Pages/FoodStores/Show', compact('data', 'food_menu'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('FoodStoresOrganizer')->with('error', 'Food Store Has Been Deleted successfully');
    }

     function FoodMenuDelete($id)
    {
